...
<table><tr>
    <td>All platforms:</td>
    <td>
      <a href="https://github.com/conda-forge/pymovements-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/pymovements-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
pixi add pymovements
# for installing globally
pixi global install pymovements
```
...
It is possible to list all of the versions of `pymovements` available on your platform:
...
```
pixi search pymovements --channel conda-forge
```
